...
// precision mediump samplerBuffer; disabled because not useable on some gpus in GLSL in #330
// precision mediump usamplerBuffer; disabled because not useable on some gpus in GLSL in #330
