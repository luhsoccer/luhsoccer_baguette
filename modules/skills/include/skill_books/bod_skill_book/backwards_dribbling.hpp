...
/**
 * @brief Backwards dribbling allows the robot to dribble the ball in regular
 * play or ball placement
 *
 * The robot prepositions itself towards the target position before it retreives
 * the ball and dribbles with it backwards to the target position. If the robot
 ...
 */
class BackwardsDribblingBuild : public SkillBuilder
{
   public:
    BackwardsDribblingBuild();
