...
InterceptBallAtPointBuild::InterceptBallAtPointBuild()
    : SkillBuilder("InterceptBallAtPoint",  //
                   {},                      //
                   {"Intercept Point"},     //
                   {},                      //
                   {},                      //
...
void InterceptBallAtPointBuild::buildImpl(const config_provider::ConfigStore& cs) {
    ...
    wait_for_kick.addFeature(TargetFeature(PointShape({TD_Pos::POINT, 0})));
