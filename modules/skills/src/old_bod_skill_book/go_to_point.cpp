...
void GoToPointBuild::buildImpl(const config_provider::ConfigStore& /*cs*/) {
    constexpr double DISTANCE_FOR_ALIGNED_MOVEMENT = 1.0;
    ...
    turn_to_target.setRotationControl(HeadingRotationControl({TD_Pos::POINT, 0}, face_away, 0.75));
    ...
    drive_to_target.setRotationControl(HeadingRotationControl({TD_Pos::POINT, 0}, face_away, 2.0));
