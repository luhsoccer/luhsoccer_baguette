...
RobotDynamic::RobotDynamic()
    : mass(robotControlConfig().simulation_mass),
      friction(robotControlConfig().simulation_friction),
      acc_k_p(robotControlConfig().simulation_acc_k_p),
      acc_k_v(robotControlConfig().simulation_acc_k_v),
      acc_scale(robotControlConfig().simulation_acc_scale),
      ...
      max_acc_x(robotControlConfig().robot_max_acc_x),
      max_acc_y(robotControlConfig().robot_max_acc_y),
      max_acc_theta(robotControlConfig().robot_max_acc_theta),
      max_brk_x(robotControlConfig().robot_max_brk_x),
      max_brk_y(robotControlConfig().robot_max_brk_y),
      max_brk_theta(robotControlConfig().robot_max_brk_theta) {}
